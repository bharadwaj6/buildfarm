...
public class ActionCacheConfigLoader {
   ...
   */
  public static ActionCacheConfig loadFromFile(File configFile)
   ...
   * @throws ConfigurationException if the configuration is invalid
   */
  public static ActionCacheConfig loadFromStream(InputStream inputStream)
   ...
   */
  @VisibleForTesting
  public static ActionCacheConfig loadFromMap(Map<String, Object> configMap)
      throws ConfigurationException {
    try {
      Yaml yaml = new Yaml(new Constructor(ActionCacheConfig.class));
