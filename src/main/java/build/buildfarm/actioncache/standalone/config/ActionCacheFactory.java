...
public class ActionCacheFactory {
   ...
   */
  public static ActionCache create(ActionCacheConfig config) throws ActionCacheConfigLoader.ConfigurationException {
    List<ActionCacheAdapter> adapters = createAdapters(config);
    return new StandaloneActionCache(adapters);
  }
  
  private static List<ActionCacheAdapter> createAdapters(ActionCacheConfig config) throws ActionCacheConfigLoader.ConfigurationException {
  ...
  private static ActionCacheAdapter createAdapter(AdapterConfig config) throws ActionCacheConfigLoader.ConfigurationException {
    switch (config.getType()) {
      ...
      default:
        throw new ActionCacheConfigLoader.ConfigurationException("Unknown adapter type: " + config.getType());
    }
  }
  
  private static ActionCacheAdapter createRedisAdapter(Map<String, String> properties) throws ActionCacheConfigLoader.ConfigurationException {
  ...
  private static ActionCacheAdapter createInMemoryAdapter(Map<String, String> properties) throws ActionCacheConfigLoader.ConfigurationException {
    // This would be implemented when the in-memory adapter is implemented
    // For now, we'll throw an exception
    throw new ActionCacheConfigLoader.ConfigurationException("In-memory adapter not yet implemented");
  }
  
  private static ActionCacheAdapter createFileSystemAdapter(Map<String, String> properties) throws ActionCacheConfigLoader.ConfigurationException {
    // This would be implemented when the file system adapter is implemented
    // For now, we'll throw an exception
    throw new ActionCacheConfigLoader.ConfigurationException("File system adapter not yet implemented");
  }
}