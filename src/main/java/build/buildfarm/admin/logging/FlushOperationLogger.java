...
public class FlushOperationLogger {
  ...
  public void logActionCacheFlush(
    ...
    if (response.isSuccess()) {
      ...
      logger.warning(logMessage.append(", message='").append(response.getMessage()).append("'").toString());
    }
  }
   ...
   * @param response the flush response
   */
  public void logCASFlush(
      String username, CASFlushRequest request, CASFlushResponse response) {
    String timestamp = getCurrentTimestamp();
